...
import useGraphHover from './useGraphHover.js'
import useThrottledCallback from './useThrottledCallback.js'
import { NumberFormat, prettyNumber } from '@based/pretty-number'
import { prettyDate } from '@based/pretty-date'
import { LineGraphData, LineXGraphFormat } from './types.js'
import {
  NON_SEMANTIC_COLOR,
  NonSemanticColor,
  Text,
      ...
      >
        <div
          style={{
            ...
            width: 15,
            border: border(),
            backgroundColor: NON_SEMANTIC_COLOR[values[0].color],
            height: 15,
          }}
        />
        {values.slice(1).map((value, i) => (
          <div
            ...
            style={{
              ...
              width: 15,
              border: border(),
              backgroundColor: NON_SEMANTIC_COLOR[value.color],
              height: 15,
            }}
          />
        ))}
        ...
        >
          ...
          >
            <Text style={{ fontWeight: 600 }}>
              <span style={{ color: NON_SEMANTIC_COLOR[values[0].color] }}>
                &#x2022;{' '}
              </span>
              {prettyNumber(
                values[0].y,
            ...
            {values.slice(1).map((value, i) => (
              <Text style={{ fontWeight: 600 }} key={i}>
                <span style={{ color: NON_SEMANTIC_COLOR[value.color] }}>
                  &#x2022;{' '}
                </span>
